...
def run_c3d(num_words=1, use_pretrained=True, seed: int = 42, out_dir: str = "results"):
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    run_c3d(num_words=args.num_words, use_pretrained=not args.no_pretrained, seed=args.seed, out_dir=args.out_dir)
